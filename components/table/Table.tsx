...
import { flatArray, treeMap, treeFilter, normalizeColumns } from './util';
...
export default class Table<T> extends React.Component<TableProps<T>, any> {
  ...
  getSortOrderColumns(columns?) {
    return treeFilter(columns || this.columns || [], column => 'sortOrder' in column);
  }

  getFilteredValueColumns(columns?) {
    return treeFilter(columns || this.columns || [], column => typeof column.filteredValue !== 'undefined');
  }
